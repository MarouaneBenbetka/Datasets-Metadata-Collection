...
# this is a list of the aviailable datasets in the UCI repository that can be collected
...
def get_datasets_metadata_uci():
    ...
    save_raw_data_to_json(result, 'uci')
    return result
